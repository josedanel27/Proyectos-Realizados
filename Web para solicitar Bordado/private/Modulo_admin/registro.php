    ...
    if (isset($_POST['button'])){
        ...
        if (!empty($_POST['email'])&& !empty($_POST['password'])){
            ...
            if ($vali == 0){
                ...
                $sql = "INSERT INTO tb_usuario (ID_usuario, Nombre, Apellido, Cedula, Telefono, email, username, contrasenia, anio_nacimiento, Type_Us) VALUES (NULL,:nombr, :apellid, :cedul, :telefon, :imeil, 'clit', :passw, :ani, '10');";
