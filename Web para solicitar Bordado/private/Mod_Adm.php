...
<body>
    <header >
        ...
        <nav>
            ...
            <a href="Modulo_admin/List_pedi.php">Ver lista de Pedidos</a>
            <a href="Modulo_admin/List_pag.php">Ver lista de pagos</a>
            <a href="Modulo_admin/registro.php">Registrar Administrador</a>
            <a href="../logout.php">Cerrar Sesion</a>
        </nav>

        <div class = "Texto_Inicio">
            <h1>Has ingresado al panel de administración!</h1>
            <?php  if (!empty($user)): ?>
    ...
    <main>
        <section class="contenedor"> 
            ...
            <div class="Section_botones">
                <div class="Botones">
                    <a href="Modulo_admin/List_pedi.php" class="botones_inicio1">Lista de Pedidos</a>
                </div>

                <div class="Botones">
                    <a href="Modulo_admin/List_pag.php" class="botones_inicio2">Lista de pagos</a>
                </div>

                <div class="Botones">
                    <a href="../logout.php"class = "botones_inicio3">Cerrar Sesión</a>
                </div>
